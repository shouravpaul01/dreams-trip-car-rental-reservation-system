...
const CarCard = ({ car }: { car: TCar }) => {
  return (
    <div className="card bg-base-100 border hover:shadow-xl  p-3">
      <figure>
        <img src={car.image} alt={car.name} className="w-full h-[250px]" />
      </figure>
      ...
      <div className="card-body p-3">
        ...
        <div className="card-actions justify-end items-center">
          <p>
            Price: <span className="font-bold">{car.pricePerHour} /hr</span>
          </p>
          <Link
            to={`/booking/${car._id}`}
